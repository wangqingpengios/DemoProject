...
@implementation RuralCategoryView
...
- (void)setupUI {
    ...
    for (int i = 0; i < array.count; ++i) {
        ...
        UIButton * button = [self al_textButton:array[i] fontSize:15 normalColor:[UIColor blackColor] selectedColor:UIColorFromRGB(0x56d176)];
    ...
    lineView.backgroundColor = UIColorFromRGB(0x56d176);
    [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.buttons[0].mas_bottom);
        make.centerX.equalTo(self.buttons[0]);
        make.width.mas_equalTo(AL_SCREEN_WIDTH/2);
