...
#import "RuralAllViewController.h"
#import "RurakThemeTableViewCell.h"

@interface RuralAllViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@end

@implementation RuralAllViewController
